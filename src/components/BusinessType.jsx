...
class BusinessType extends Component {
    ...
    structure = (values) => {
        ...
        this.props.history.push('/profession' +'?lp_request_id=' + lp + '&gclid=' + gclid + '&zip_code=' + zip + '&legal_business_name=' + businessName + '&coverage_type=coverage' + '&business_structure=' + type);
