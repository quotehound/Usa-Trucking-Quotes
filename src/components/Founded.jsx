...
class Founded extends Component {
    ...
    nextStep = (value) => {
     ...
     const urlSearch = window.location.search;
        ...
        this.props.history.push('/revenue' + '?lp_request_id=' + lp + '&gclid=' + gclid + '&zip_code=' + zip + '&egal_business_name=' + businessName + '&coverage_type=' + coverageTypes + '&business_structure=' + structure + '&business_profession=' + profession + '&year_business_founded=' + year);
                                        ...
                                        <div className="mt-6">
                                            <div className="w-full flex text-sm leading-5">
                                                ...
                                                <div className="text-sm leading-5 buttonBlockRow">
                                                    ...
                                                    <input className="appearance-none w-full p-3 text-md font-semibold leading-none bg-white rounded" type="text" name="year" placeholder="####" pattern="\d*" id="year" maxLength={4} />
                                                </div>
...
export default withRouter(Founded)
