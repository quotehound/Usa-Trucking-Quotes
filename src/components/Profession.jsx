...
class Profession extends Component {
    ...
    nextStep = (values) => {
        ...
        let businessProfession = document.getElementById('businessProfession').value;

        if(businessProfession.length < 4){
                             ...
                             <div className="mt-6">
                                 <div className="w-full flex text-sm leading-5">
                                     ...
                                     <div className="text-sm leading-5 buttonBlockRow">
                                       ...
                                       <input className="appearance-none w-full p-3 text-lg font-semibold leading-none bg-white rounded " type="text" name="businessProfession" placeholder="Profession" id="businessProfession" minLength={4}/>
                                      </div>
                                 </div>
