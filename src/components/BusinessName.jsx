                                    ...
                                    <div className="mt-6">
                                        <div className="w-full flex text-sm leading-5">
                                            ...
                                            <div className="text-sm leading-5 buttonBlockRow">
                                              ...
                                              <input className="appearance-none w-full p-3 text-lg font-semibold leading-none bg-white rounded " type="text" name="businessName" placeholder="Business Name" id="businessName" minLength={4}/>
                                             </div>
                                        </div>
...
export default withRouter(BusinessName)